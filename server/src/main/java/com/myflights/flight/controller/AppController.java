...
import com.myflights.flight.repository.loginRepo;
...
public class AppController {
    ...
    @GetMapping("/login") // find-flights/JFK/CLT/12-10-2023        /find-flights?org=JFK&dest=CLT&date=12-10-2023
    public ResponseEntity<ObjectResponse>login(@RequestParam String username,
  ...
  ObjectResponse resp =  new ObjectResponse();
   try {
     // List<Flight> flights = flightService.findFlightsByDate( origin, dest, date); 
    Login user = logrepo.findByName(username);
